...
namespace CanalTP\SamMonitoringComponent\Test\Service\MessageBroker;
...
class PgsqlTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCheckMethodOk()
    {
        ...
        $service = new \CanalTP\SamMonitoringComponent\Test\Data\Service\MessageBroker\RabbitMqMock(true);
    ...
    public function testCheckMethodKo()
    {
        ...
        $service = new \CanalTP\SamMonitoringComponent\Test\Data\Service\MessageBroker\RabbitMqMock(false);
        $this->assertEquals($service->getState(), \CanalTP\SamMonitoringComponent\StateMonitorInterface::UNKNOWN);
